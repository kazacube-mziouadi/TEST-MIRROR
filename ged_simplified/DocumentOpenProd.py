    ...
    def compute_link_document(self, document_path, directory):
        ...
        query = sql.SQL('''
            ...
            ''').format(
                ...
                directory_id = sql.Identifier(str(file_attributes["directory_id"])),
                ...
                write_uid = sql.Identifier(str(self._uid)),
                create_uid = sql.Identifier(str(self._uid)),
                user_id = sql.Identifier(str(self._uid)),
                company_id = sql.Identifier(str(self.env.user.company_id.id)),
