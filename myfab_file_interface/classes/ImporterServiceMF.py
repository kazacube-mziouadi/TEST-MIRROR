...
class ImporterServiceMF(models.TransientModel):
    ...
    def apply_orm_method_to_model(self, model_name, record_fields_dict, record_to_write_fields_dict, orm_method_name):
        ...
        self.set_relation_fields_to_ids(model_name, record_fields_dict)
        if record_to_write_fields_dict:
            self.set_relation_fields_to_ids(model_name, record_to_write_fields_dict)
    ...
    def set_relation_field_to_id(self, parent_model_name, field_name, relation_field_dict):
        ...
        if "id" in relation_field_dict and type(relation_field_dict["id"]) is not int:
            ...
            return (6, 0, [relation_field_id]) if field_model.ttype == "many2many" else relation_field_id
