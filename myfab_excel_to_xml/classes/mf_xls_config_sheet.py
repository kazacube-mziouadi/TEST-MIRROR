...
class mf_xls_config_sheet(models.Model):
    ...
    beacon_for_sheet_in_parent = fields.Char()
    beacon_per_row_in_parent = fields.Char(required=True)
    level_field_id = fields.Many2one('mf.xls.config.sheet.level', string='Level field')
